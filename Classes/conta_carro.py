...
class ContaCarroPageTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_car_creation(self):
        ...
        carro = ContaCarro(placa, modelo, marca, ano, cor, chassi, quilometragem, preco, categoria)
        carro.save()

        # Recupera o carro do banco de dados
        self.cursor.execute("SELECT * FROM carros WHERE id = ?", (carro.id,))
